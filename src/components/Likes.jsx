  ...
  return (
    <>
      ...
      <section className="flex justify-around bg-teal-700 w-auto">
        ...
        <div className="w-64 bg-very-pale-blue rounded-sm items-center p-5 m-5">
          ...
          <div className="flex justify-between">
            ...
            <p className="flex items-center text-lime-green text-xs "><img className="" src="./icon-up.svg"></img>3%</p>
          </div>
        </div>
        ...
        <div className="w-64 bg-very-pale-blue rounded-sm items-center p-5 m-5">
          ...
          <div className="flex justify-between">
            ...
            <p className="flex items-center text-bright-red text-xs "><img className="" src="./icon-down.svg"></img>2%</p>
          </div>
        </div>
        ...
        <div className="w-64 bg-very-pale-blue rounded-sm items-center p-5 m-5">
          ...
          <div className="flex justify-between">
            ...
            <p className="flex items-center text-lime-green  text-xs "><img className="" src="./icon-up.svg"></img>2257%</p>
          </div>
        </div>
        ...
        <div className="w-64 bg-very-pale-blue rounded-sm items-center p-5 m-5">
          ...
          <div className="flex justify-between">
            ...
            <p className="flex items-center text-lime-green  text-xs  "><img className="" src="./icon-up.svg"></img>1375%</p>
          </div>
        </div>
      </section>
      <section className="flex justify-around bg-teal-200 w-auto">
        <div className="w-64 bg-very-pale-blue rounded-sm items-center p-5 m-5">
          ...
          <div className="flex justify-between">
            ...
            <p className="flex items-center text-lime-green  text-xs  "><img className="" src="./icon-up.svg"></img>303%</p>
          </div>
        </div>
        ...
        <div className="w-64 bg-very-pale-blue rounded-sm items-center p-5 m-5">
          ...
          <div className="flex justify-between">
            ...
            <p className="flex items-center text-lime-green  text-xs  "><img className="" src="./icon-up.svg"></img>553%</p>
          </div>
        </div>
        ...
        <div className="w-64 bg-very-pale-blue rounded-sm items-center p-5 m-5">
          ...
          <div className="flex justify-between">
            <p className="font-bold text-3xl">107</p>
             <p className="text-bright-red text-xs flex items-center "><img className=""  src="./icon-down.svg"></img>19%</p>
          </div>
        </div>
        ...
        <div className="w-64 bg-very-pale-blue rounded-sm items-center p-5 m-5">
          ...
          <div className="flex justify-between">
            ...
            <p className="text-bright-red text-xs flex items-center "><img className=""  src="./icon-down.svg"></img>12%</p>
          </div>
        </div>
      </section>
    </>
